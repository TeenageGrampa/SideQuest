...
<html>
	<head>
		<title>Tests for redux-localstorage-simple</title>
		<style>
			body {color: #888;}
			p {margin: 3px;}
	...
	<body>
		<div id="testResults">
			<h1>Tests for <u>redux-localstorage-simple</u></h1>
			<p>Tests are run through your browser because LocalStorage needs to exist in the environment.</p>
			<br/>
			<p><strong>Test 0</strong>: LocalStorage, are you there? <span id="test0"></span></p>
