class UsersController < ApplicationController
    ...
    def show
        ...
        dungeon_master_games = user.dungeon_masters.map{ | dungeon_master | {
            id: dungeon_master.game.id, name: dungeon_master.game.name, dungeon_master: dungeon_master.game.dungeon_master.user, party_ids: dungeon_master.game.party_members.map{ |member| member.character.user.id }, party: dungeon_master.game.party_members.map{ | member |  {id: member.character.id, name: member.character.name, level: member.character.level, alignment: member.character.alignment, class: member.character.character_classes, race: member.character.character_races, user_id: member.character.user.id}}, players: dungeon_master.game.party_members.map{ | member | member.character.user}, explevel: dungeon_master.game.explevel, rplevel: dungeon_master.game.rplevel, location: dungeon_master.game.location, desc: dungeon_master.game.desc, messages: dungeon_master.game.messages
        }}
        render json: {
